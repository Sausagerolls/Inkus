...
- Read the code.
- Quote small excerpts in articles, posts, talks, or reviews **with attribution** (a link to this repository is enough).
- Build the project locally for **personal, non-distributed evaluation** on your own devices.
- File issues or pull requests against this repository (we may or may not merge them; see the README).
...
If you'd like to do anything beyond the *What you may do* list — including using a substantive part of this code in your own project, or shipping a derivative — please email **contact@giantmushroom.studio**. We're usually happy to say yes; we'd just like to know.
